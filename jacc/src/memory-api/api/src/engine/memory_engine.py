...
if TYPE_CHECKING:
    from src.extensions import OperationValidatorExtension, TenantExtension
...
class MemoryEngine(MemoryEngineInterface):
    ...
    def __init__(
        ...
        See src.config for environment variable names and defaults.
    ...
    async def _validate_operation(self, validation_coro) -> None:
        ...
        from src.extensions import OperationValidationError
    ...
    async def _authenticate_tenant(self, request_context: "RequestContext | None") -> str:
        ...
        from src.extensions import AuthenticationError
    ...
    def retain(
        ...
        from src.models import RequestContext as RC
    ...
    async def retain_batch_async(
        ...
        *,
        ...
        if self._operation_validator:
            from src.extensions import RetainContext
        ...
        if self._operation_validator:
            from src.extensions import RetainResult
    ...
    async def recall_async(
        ...
        *,
        ...
        # Validate operation if validator is configured
        if self._operation_validator:
            from src.extensions import RecallContext
            ...
            for attempt in range(max_retries + 1):
                try:
                    ...
                    if is_connection_error and attempt < max_retries:
                        ...
                        error_msg = str(e)
                        if self._operation_validator:
                            from src.extensions.operation_validator import RecallResult
...
- Small changes in confidence are normal; large jumps should be rare"""
    ...
    async def reflect_async(
        ...
        *,
        ...
        # Validate operation if validator is configured
        if self._operation_validator:
            from src.extensions import ReflectContext
        ...
        # Call post-operation hook if validator is configured
        if self._operation_validator:
            from src.extensions.operation_validator import ReflectResultContext
